...
@Import(OrderAppServiceIntegrationTest.TestConfig.class)
@ActiveProfiles("test")
public class OrderAppServiceIntegrationTest {
    ...
    static class TestConfig {
        ...
        @Bean
        public DomainOrderService domainOrderService() {
            return Mockito.mock(DomainOrderService.class);
        }
        ...
        @Bean
        public com.articurated.order.mapper.OrderMapper orderMapper() {
            return Mockito.mock(com.articurated.order.mapper.OrderMapper.class);
        }
        ...
        @Bean
        public com.articurated.order.service.OrderAmountCalculator orderAmountCalculator() {
            return Mockito.mock(com.articurated.order.service.OrderAmountCalculator.class);
        }
    }
    ...
    // invoice generation is not emitted automatically on payment anymore
    verify(eventPublisher, times(0)).publishAfterCommit(any());
    }
}
